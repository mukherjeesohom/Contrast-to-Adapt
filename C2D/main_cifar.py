...
def create_model_reg(net='resnet18', dataset='cifar10', num_classes=10, device='cuda:0', drop=0):
    if net == 'resnet18':
...
def create_model_bit(net='resnet18', dataset='cifar10', num_classes=10, device='cuda:0', drop=0):
    if net == 'resnet50':
